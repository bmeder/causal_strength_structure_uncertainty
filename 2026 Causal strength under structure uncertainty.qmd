...
abstract: "How should a learner estimate the strength of a causal influence when it is uncertain whether the causal relation exists? We address this question using the framework of Bayesian causal induction. Existing accounts have primarily focused either on inference about causal structure or on estimation of causal strength under an assumed structure. We propose _structure-averaged causal strength_ as a method for estimating causal strength under structure uncertainty. By averaging causal strength across alternative structures according to their posterior probabilities, the account provides a strength estimate that reflects uncertainty about both whether a causal relation exists and how strong it is. Normatively, our analyses clarify how causal strength should be estimated when the existence of the causal relation itself remains uncertain. Empirically, structure-averaged strength provides accurate predictions of human judgments of causal influence across a broad set of published studies, suggesting that human causal judgments reflect uncertainty about both causal strength and causal structure. Together, our analyses show how inferences about causal structure shape judgments of causal strength under uncertainty."
