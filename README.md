...
- `data/`: Contains the empirical data sets used for the model comparison. The data consist of contingency information and aggregate causal judgments reconstructed or obtained from previously published causal-learning studies.

- `meta_analysis_preprocessing.R`:  a helper function that imports and preprocesses the individual data sets for the main analysis.

- `studies_model_comparison.csv`. In addition, the individual data files contain additional info taking from the original publications (e.g. number of participants, question wording used to elicit causal judgements, used experimental design etc.)
